...
<head>
    ...
    <title><?php echo TITLE . ' COTIZAHOY - Inicio' ?></title>
</head>
                            ...
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    <div class="text-center">
                                        <h3 class="">COTIZAHOY</h3>
                                    </div>
                                    <div class="mb-4 text-center">
                            <img src="<?php echo BASE_URL; ?>assets/images/logo_cotiza.png" width="120" alt="" />
                        </div>
                                    <div class="login-separater text-center mb-4"> <span>Para iniciar sesión solicte una cuenta</span>
                                        <hr />
                                    </div>
                                    <div class="form-body">
                                        <form class="row g-3" id="formulario" method="POST" autocomplete="off">
                                            ...
                                            <div class="col-md-12 text-end"> <a href="<?php echo BASE_URL . 'principal/forgot'; ?>">Olvide mi contraseña?</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
